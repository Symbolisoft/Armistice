...
from campaigns.campaigns import BRITISH_CAMPAIGN
...
class BritCampaignMenu:
    def __init__(self, game):
        ...
        self.line2 = self.game.font.render(f'{BRITISH_CAMPAIGN[self.game.camp_level-1][0]}', True, GREEN)
        self.line2_rect = self.line2.get_rect(x=850, y=190)
        self.line3 = self.game.font.render(f'{BRITISH_CAMPAIGN[self.game.camp_level-1][1]}', True, GREEN)
        self.line3_rect = self.line3.get_rect(x=850, y=220)
        self.line4 = self.game.font.render(f'{BRITISH_CAMPAIGN[self.game.camp_level-1][2]}', True, GREEN)
        self.line4_rect = self.line4.get_rect(x=850, y=240)
        self.line5 = self.game.font.render(f'{BRITISH_CAMPAIGN[self.game.camp_level-1][3]}', True, GREEN)
        self.line5_rect = self.line5.get_rect(x=850, y=260)
        self.line6 = self.game.font.render(f'{BRITISH_CAMPAIGN[self.game.camp_level-1][4]}', True, GREEN)
        self.line6_rect = self.line6.get_rect(x=850, y=280)
        self.line7 = self.game.font.render(f'{BRITISH_CAMPAIGN[self.game.camp_level-1][5]}', True, GREEN)
        self.line7_rect = self.line7.get_rect(x=850, y=300)
        self.line8 = self.game.font.render(f'{BRITISH_CAMPAIGN[self.game.camp_level-1][6]}', True, GREEN)
        self.line8_rect = self.line8.get_rect(x=850, y=330)
        self.line9 = self.game.font.render(f'{BRITISH_CAMPAIGN[self.game.camp_level-1][7]}', True, GREEN)
        self.line9_rect = self.line9.get_rect(x=850, y=350)
        self.line10 = self.game.font.render(f'{BRITISH_CAMPAIGN[self.game.camp_level-1][8]}', True, GREEN)
        self.line10_rect = self.line10.get_rect(x=850, y=370)
        self.line11 = self.game.font.render(f'{BRITISH_CAMPAIGN[self.game.camp_level-1][9]}', True, GREEN)
        self.line11_rect = self.line11.get_rect(x=850, y=390)
        self.line12 = self.game.font.render(f'{BRITISH_CAMPAIGN[self.game.camp_level-1][10]}', True, GREEN)
        self.line12_rect = self.line12.get_rect(x=850, y=420)
        self.line13 = self.game.font.render(f'{BRITISH_CAMPAIGN[self.game.camp_level-1][11]}', True, GREEN)
        self.line13_rect = self.line13.get_rect(x=850, y=440)
        self.line14 = self.game.font.render(f'{BRITISH_CAMPAIGN[self.game.camp_level-1][12]}', True, GREEN)
        self.line14_rect = self.line14.get_rect(x=850, y=460)
        self.line15 = self.game.font.render(f'{BRITISH_CAMPAIGN[self.game.camp_level-1][13]}', True, GREEN)
